...
export default {
  ...
  // Usage: <html class="dark"> to enable dark mode
  darkMode: 'class',
    ...
    extend: {
      ...
      colors: {
        ...
        secondary: {
          ...
          400: '#22d3ee',
          500: '#06b6d4',
          600: '#0891b2', // Main secondary color
          700: '#0e7490',
          800: '#155e75',
          900: '#164e63',
          950: '#083344',
      ...
      boxShadow: {
        ...
        'medium': '0 4px 20px -2px rgba(0, 0, 0, 0.1), 0 15px 30px -4px rgba(0, 0, 0, 0.08)',
        'hard': '0 10px 40px -3px rgba(0, 0, 0, 0.15), 0 20px 50px -6px rgba(0, 0, 0, 0.12)',
